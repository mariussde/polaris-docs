---
title: Thèmes
description: Cette section fournit un aperçu des Thèmes.
---

> Personnalisez les couleurs du thème dans votre projet pour créer une interface cohérente et visuellement attrayante. Chaque thème vient avec une palette de couleurs unique facile à ajuster.

## Personnaliser

Vous avez la flexibilité de changer le thème de cette documentation en modifiant les variables Tailwind CSS dans `@styles/globals.css` et en ajustant les couleurs de coloration syntaxique dans `@styles/syntax.css`.

Si vous souhaitez utiliser les thèmes prédéfinis Nebula, Halloween ou Ocean, copiez simplement et collez le code fourni dans les fichiers respectifs. Une fois ajouté, vous verrez immédiatement les changements visuels reflétés dans votre documentation, améliorant son apparence et sa sensation générale.

### Thème Nebula

Le thème Nebula fournit une palette de couleurs vibrante, rendant votre application visuellement attrayante et engageante.
Le thème est inspiré du cosmos, présentant des couleurs vibrantes qui améliorent l'expérience de lecture.
...
Le thème Halloween infuse votre documentation avec une atmosphère festive et effrayante, idéale pour le contenu saisonnier. Son design est inspiré des motifs d'Halloween, présentant des couleurs étranges et des éléments ludiques qui améliorent l'expérience de lecture globale.
...
Le thème Ocean présente des couleurs apaisantes tirées des profondeurs de la mer, favorisant un environnement de lecture tranquille. Son design évoque un sentiment de calme, améliorant l'expérience globale pour les utilisateurs.
...
Pour des thèmes supplémentaires, visitez ce site web fantastique avec des thèmes Shadcn préfabriqués : https://tinte.railly.dev/shadcn